...
- [ ] **Step 3: Implement the pure selector and wire the adapter**
...
- [ ] **Step 3: Implement draft filtering and API serialization**
...
- [ ] **Step 1: Add a failing deterministic browser case**
...
- [ ] **Step 2: Run the browser case and confirm RED**
...
- [ ] **Step 3: Complete the test fixture and confirm GREEN**
...
- [ ] **Step 5: Rebuild and verify the local Apple Container**
