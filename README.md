...
| --- | --- |
| Analyse | `ESSENTIA_ANALYSIS_WORKERS`, `ESSENTIA_ANALYSIS_CPU_WORKERS`, `ESSENTIA_GPU_WORKERS`, `ESSENTIA_GPU_BATCH_SIZE`, `ESSENTIA_GPU_QUEUE_SIZE`, `ESSENTIA_MAX_AUDIO_SECONDS`, `ESSENTIA_GENRE_THRESHOLD`, `ESSENTIA_MOOD_THRESHOLD`, `ESSENTIA_GENRE_COUNT`, `ESSENTIA_WRITE_CONFIDENCE_TAGS`, `ESSENTIA_OVERWRITE_EXISTING`, `ESSENTIA_COMPUTE` |
